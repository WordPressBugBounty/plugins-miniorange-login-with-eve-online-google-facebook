...
<div class="mo_oauth_card">
	<div class="mo_oauth_card_header"><h3><?php esc_html_e( 'Login Settings', 'miniorange-login-with-eve-online-google-facebook' ); ?></h3></div>
	<div class="mo_oauth_card_body">
<div  id="wid-shortcode" class="mo_table_layout mo_oauth_attribute_page_font mo_oauth_outer_div">
<div class="mo_oauth_customization_header"><div class="mo_oauth_attribute_map_heading mo_oauth_x_signinsettings_1"><b class="mo_oauth_position"><?php esc_html_e( 'Sign in options', 'miniorange-login-with-eve-online-google-facebook' ); ?></b></div><div class="mo_oauth_tooltip mo_oauth_tooltip_float_right"><span class="mo_tooltiptext"  >Know how this is useful</span><a class="mo_oauth_x_signinsettings_2" target="_blank" href="https://developers.miniorange.com/docs/oauth/wordpress/client/login-options" rel="noopener noreferrer">
	...
	<form id="mo_oauth_woocommerce_login_form" name="mo_oauth_woocommerce_login_form" method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=mo_oauth_settings&tab=signinsettings' ) ); ?>">
		...
		<ul>
			<li>
				...
				if ( ! class_exists( 'WooCommerce' ) ) {
					echo 'disabled';
				} elseif ( isset( $first_app['mo_oauth_show_on_woocommerce_login_form'] ) && 'true' === $first_app['mo_oauth_show_on_woocommerce_login_form'] ) {
					echo 'checked';
				}
				?>
				/>
				...
				<?php if ( ! class_exists( 'WooCommerce' ) ) : ?>
					<p class="description"><?php esc_html_e( 'WooCommerce is not installed/active. Install and activate WooCommerce to enable this option.', 'miniorange-login-with-eve-online-google-facebook' ); ?></p>
				<?php endif; ?>
			</li>
		</ul>
		<table class="mo_settings_table">
			<tr>
				<td>
					<input type="submit" class="button button-primary button-large" value="<?php esc_html_e( 'Save Settings', 'miniorange-login-with-eve-online-google-facebook' ); ?>" <?php disabled( ! class_exists( 'WooCommerce' ) ); ?>>
				</td>
				<td>&nbsp;</td>
			</tr>
		</table>
	...
	<form id="form-common" name="form-common" method="post" action="admin.php?page=mo_oauth_settings&tab=signinsettings">
		...
		<table class="mo_settings_table mo_oauth_client_mapping_table">
			...
			<tr class="mo_oauth_configure_table_rows">
				<td>
				<div>
				<h3 class="mo_oauth_attribute_map_heading mo_oauth_x_signinsettings_3">
				<?php esc_html_e( 'Advance Security Settings', 'miniorange-login-with-eve-online-google-facebook' ); ?></h3></div>
				</td>
			</tr>
			<tr>
			<td class="mo_oauth_x_signinsettings_4">
			<span>
		...
		<tr id="email-verified-keys-row" class="mo_oauth_x_signinsettings_5">
		<td >
			<label for="email-input1"><strong class="mo_strong"><?php esc_html_e( 'Key', 'miniorange-login-with-eve-online-google-facebook' ); ?> <span class="mo_oauth_x_demo_3">*</span>: </strong></label>
			</td> <td>
			<input 
	class="mo_oauth_input mo_oauth_x_signinsettings_6"
...
/>
		...
		<tr id="email-verified-values-row" class="mo_oauth_x_signinsettings_5">
		<td>
			<label for="email-input2"><strong class="mo_strong"><?php esc_html_e( 'Value', 'miniorange-login-with-eve-online-google-facebook' ); ?> <span class="mo_oauth_x_demo_3">*</span>: </strong></label> </td> <td>
			<input 
...
<div id="advanced_settings_sso" class="mo_table_layout mo_oauth_outer_div">
	<form id="signing_setting_form" name="f" method="post" action="">
		...
		<div class="mo_oauth_customization_header mo_oauth_x_signinsettings_7"><div class="mo_oauth_attribute_map_heading mo_oauth_x_signinsettings_1">
							<?php esc_html_e( 'WordPress User Profile Sync-up Settings', 'miniorange-login-with-eve-online-google-facebook' ); ?></div><div class="mo_oauth_tooltip mo_oauth_tooltip_float_right"><span class="mo_tooltiptext"  >About Auto Create Users</span><a class="mo_oauth_x_signinsettings_2" target="_blank" href="https://developers.miniorange.com/docs/oauth/wordpress/client/auto-register-users" rel="noopener noreferrer">
		...
		<table class="mo_oauth_client_mapping_table mo_oauth_x_signinsettings_8">
			<tbody>
				<tr>
					<td>
						<font class="mo_oauth_x_signinsettings_9">
				...
				<tr>
					<td>
						<font class="mo_oauth_x_signinsettings_10">
				...
				<tr>
					<td>
						<h3 class="mo_oauth_signing_heading mo_oauth_x_signinsettings_3">
				...
				<tr>
					...
					<td><input disabled="true" class="mo_oauth_input_disabled mo_oauth_x_signinsettings_11" type="text"></td>
				</tr>
				<tr>
					<td>
						<font class="mo_oauth_x_signinsettings_10">
				...
				<tr>
					...
					<td><input disabled="true" class="mo_oauth_input_disabled mo_oauth_x_signinsettings_11" type="text" placeholder="domain1.com,domain2.com">
					</td>
				</tr>
				<tr>
					<td>
